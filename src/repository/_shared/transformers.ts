...
export function toUser(dbUser: any): User {
  ...
  return {
    ...
    priceProviderGroup: dbUser?.priceProviderGroup ?? null,
    latencyProviderGroup: dbUser?.latencyProviderGroup ?? null,
...
export function toKey(dbKey: any): Key {
  return {
    ...
    priceProviderGroup: dbKey?.priceProviderGroup ?? null,
    latencyProviderGroup: dbKey?.latencyProviderGroup ?? null,
...
export function toProvider(dbProvider: any): Provider {
  return {
    ...
    latencyProbeEnabled: dbProvider?.latencyProbeEnabled ?? null,
    latencyProbeModel: dbProvider?.latencyProbeModel ?? null,
    latencyProbeIntervalMs: dbProvider?.latencyProbeIntervalMs ?? null,
    latencyProbeTimeStart: dbProvider?.latencyProbeTimeStart ?? null,
    latencyProbeTimeEnd: dbProvider?.latencyProbeTimeEnd ?? null,
    latencyProbeLastAvgMs: dbProvider?.latencyProbeLastAvgMs ?? null,
    latencyProbeLastStatus: dbProvider?.latencyProbeLastStatus ?? null,
    latencyProbeLastError: dbProvider?.latencyProbeLastError ?? null,
    latencyProbeLastRunAt: dbProvider?.latencyProbeLastRunAt
      ? new Date(dbProvider.latencyProbeLastRunAt)
      : null,
