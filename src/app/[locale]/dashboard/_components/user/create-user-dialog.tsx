      ...
      startTransition(async () => {
        try {
          ...
          const keyRes = await addKey({
            ...
            priceProviderGroup: normalizeProviderGroup(data.key.priceProviderGroup),
            latencyProviderGroup: normalizeProviderGroup(data.key.latencyProviderGroup),
        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-6 pt-6 pb-6 space-y-8">
          ...
          <KeyEditSection
            keyData={{
              ...
              priceProviderGroup: normalizeProviderGroup(currentKeyDraft.priceProviderGroup),
              latencyProviderGroup: normalizeProviderGroup(currentKeyDraft.latencyProviderGroup),
