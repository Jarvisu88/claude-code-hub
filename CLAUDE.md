...
## Worker Identity
- Team: deliver-the-first-runnable-v1
- Worker: worker-2
- Role: executor
- Leader cwd: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite
- Worktree root: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/team/deliver-the-first-runnable-v1/worktrees/worker-2
- Team state root: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state
- Inbox path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/deliver-the-first-runnable-v1/workers/worker-2/inbox.md
- Mailbox path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/deliver-the-first-runnable-v1/mailbox/worker-2.json
- Leader mailbox path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/deliver-the-first-runnable-v1/mailbox/leader-fixed.json
- Task directory: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/deliver-the-first-runnable-v1/tasks
- Worker status path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/deliver-the-first-runnable-v1/workers/worker-2/status.json
- Worker identity path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/deliver-the-first-runnable-v1/workers/worker-2/identity.json

## Protocol
1. Read your inbox at `/mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/deliver-the-first-runnable-v1/workers/worker-2/inbox.md`.
...
3. Send startup ACK before task work:
   ...
   `omx team api send-message --input "{"team_name":"deliver-the-first-runnable-v1","from_worker":"worker-2","to_worker":"leader-fixed","body":"ACK: worker-2 initialized"}" --json`
...
5. Read task files from `/mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/deliver-the-first-runnable-v1/tasks/task-<id>.json` using bare `task_id` values in APIs.
...
7. Use mailbox delivery flow:
   - `omx team api mailbox-list --input "{"team_name":"deliver-the-first-runnable-v1","worker":"worker-2"}" --json`
   - `omx team api mailbox-mark-delivered --input "{"team_name":"deliver-the-first-runnable-v1","worker":"worker-2","message_id":"<MESSAGE_ID>"}" --json`
