...
- Worktree root: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/team/deliver-the-first-runnable-v1/worktrees/worker-1
- Team state root: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state
- Inbox path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/deliver-the-first-runnable-v1/workers/worker-1/inbox.md
- Mailbox path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/deliver-the-first-runnable-v1/mailbox/worker-1.json
...
- Worker status path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/deliver-the-first-runnable-v1/workers/worker-1/status.json
- Worker identity path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/deliver-the-first-runnable-v1/workers/worker-1/identity.json

## Protocol
1. Read your inbox at `/mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/deliver-the-first-runnable-v1/workers/worker-1/inbox.md`.
...
3. Send startup ACK before task work:
   ...
   `omx team api send-message --input "{"team_name":"deliver-the-first-runnable-v1","from_worker":"worker-1","to_worker":"leader-fixed","body":"ACK: worker-1 initialized"}" --json`
...
7. Use mailbox delivery flow:
   - `omx team api mailbox-list --input "{"team_name":"deliver-the-first-runnable-v1","worker":"worker-1"}" --json`
   - `omx team api mailbox-mark-delivered --input "{"team_name":"deliver-the-first-runnable-v1","worker":"worker-1","message_id":"<MESSAGE_ID>"}" --json`
