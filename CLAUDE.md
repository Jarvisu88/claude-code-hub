...
- Worktree root: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/team/fastlane-rewrite-finish-up-wor/worktrees/worker-3
- Team state root: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state
- Inbox path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/fastlane-rewrite-finish-up-wor/workers/worker-3/inbox.md
- Mailbox path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/fastlane-rewrite-finish-up-wor/mailbox/worker-3.json
...
- Worker status path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/fastlane-rewrite-finish-up-wor/workers/worker-3/status.json
- Worker identity path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/fastlane-rewrite-finish-up-wor/workers/worker-3/identity.json

## Protocol
1. Read your inbox at `/mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/fastlane-rewrite-finish-up-wor/workers/worker-3/inbox.md`.
...
3. Send startup ACK before task work:
   ...
   `omx team api send-message --input "{"team_name":"fastlane-rewrite-finish-up-wor","from_worker":"worker-3","to_worker":"leader-fixed","body":"ACK: worker-3 initialized"}" --json`
...
7. Use mailbox delivery flow:
   - `omx team api mailbox-list --input "{"team_name":"fastlane-rewrite-finish-up-wor","worker":"worker-3"}" --json`
   - `omx team api mailbox-mark-delivered --input "{"team_name":"fastlane-rewrite-finish-up-wor","worker":"worker-3","message_id":"<MESSAGE_ID>"}" --json`
