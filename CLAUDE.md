...
## Worker Identity
- Team: fastlane-rewrite-finish-up-wor
- Worker: worker-1
- Role: executor
- Leader cwd: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite
- Worktree root: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/team/fastlane-rewrite-finish-up-wor/worktrees/worker-1
- Team state root: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state
- Inbox path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/fastlane-rewrite-finish-up-wor/workers/worker-1/inbox.md
- Mailbox path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/fastlane-rewrite-finish-up-wor/mailbox/worker-1.json
- Leader mailbox path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/fastlane-rewrite-finish-up-wor/mailbox/leader-fixed.json
- Task directory: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/fastlane-rewrite-finish-up-wor/tasks
- Worker status path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/fastlane-rewrite-finish-up-wor/workers/worker-1/status.json
- Worker identity path: /mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/fastlane-rewrite-finish-up-wor/workers/worker-1/identity.json

## Protocol
1. Read your inbox at `/mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/fastlane-rewrite-finish-up-wor/workers/worker-1/inbox.md`.
2. Load the worker skill from the first existing path:
   - `${CODEX_HOME:-~/.codex}/skills/worker/SKILL.md`
   - `/mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.codex/skills/worker/SKILL.md`
   - `/mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/skills/worker/SKILL.md`
3. Send startup ACK before task work:

   `omx team api send-message --input "{"team_name":"fastlane-rewrite-finish-up-wor","from_worker":"worker-1","to_worker":"leader-fixed","body":"ACK: worker-1 initialized"}" --json`
...
5. Read task files from `/mnt/f/claudecode hub plus/claude-code-hub-go-rewrite/.omx/state/team/fastlane-rewrite-finish-up-wor/tasks/task-<id>.json` using bare `task_id` values in APIs.
...
7. Use mailbox delivery flow:
   - `omx team api mailbox-list --input "{"team_name":"fastlane-rewrite-finish-up-wor","worker":"worker-1"}" --json`
   - `omx team api mailbox-mark-delivered --input "{"team_name":"fastlane-rewrite-finish-up-wor","worker":"worker-1","message_id":"<MESSAGE_ID>"}" --json`
