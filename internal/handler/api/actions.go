...
func (h *Handler) openapiJSON(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{
		...
		"paths": gin.H{
			...
			"/api/actions/usage-logs/startUsageLogsExport":               gin.H{"post": gin.H{"summary": "Start usage logs export"}},
			"/api/actions/usage-logs/getUsageLogsExportStatus":           gin.H{"post": gin.H{"summary": "Get usage logs export status"}},
			"/api/actions/usage-logs/downloadUsageLogsExport":            gin.H{"post": gin.H{"summary": "Download usage logs export"}},
