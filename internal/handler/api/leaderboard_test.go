...
func TestLeaderboardRouteReturnsProviderScope(t *testing.T) {
	...
	store := &fakeLeaderboardLogStore{
		rows: []repository.LeaderboardRequestRow{
			{UserID: 1, UserName: "alice", ProviderID: 7, ProviderName: "provider-a", Model: "gpt-5.4", StatusCode: 200, CostUSD: udecimal.MustParse("1.5"), DurationMs: intPtr(100), TtfbMs: intPtr(30), InputTokens: intPtr(100), OutputTokens: intPtr(50)},
			{UserID: 2, UserName: "bob", ProviderID: 7, ProviderName: "provider-a", Model: "gpt-5.4", StatusCode: 500, CostUSD: udecimal.MustParse("0.5"), DurationMs: intPtr(200), TtfbMs: intPtr(60), InputTokens: intPtr(50), OutputTokens: intPtr(50)},
			{UserID: 1, UserName: "alice", ProviderID: 8, ProviderName: "provider-b", Model: "gpt-4o-mini", StatusCode: 200, CostUSD: udecimal.MustParse("2.0"), DurationMs: intPtr(100), TtfbMs: intPtr(20), InputTokens: intPtr(100), OutputTokens: intPtr(100)},
		},
	}
